---
title: Resize the SD Image
subtitle: Using GParted to shrink the disk size
author: Gary Dalton
...
pandoc: pandoc -t html5 --standalone --section-divs --template=template_github.html resize_sd_image.md -o resize_sd_image.html
tags: rpi, guide, sd, image, gparted
---
[Home](index.html)
